...
class UserControllerTest extends BaseRestAssuredTest {
    ...
    @BeforeEach
    void setUp() {
        user = userRepository.save(new User("username", passwordEncoder.encode("password"), "nickname",
    ...
    void testUpdatePasswordEndpoint() throws JsonProcessingException {
        ...
        userRepository.findByUsername("username")
            .ifPresentOrElse(user -> assertTrue(passwordEncoder.matches("newPassword", user.getPasswordHash())),
                    () -> fail("User not found"));
    }
