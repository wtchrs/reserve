...
class JwtProviderTest {
    ...
    void testAccessTokenExpiration() {
        ...
        assertFalse(jwtProvider.isAccessTokenExpired(
                jwtProvider.generateSignInToken(TestUtils.getTokenDetails(1L)).getAccessToken()
        ));
    ...
    void testRefreshTokenExpiration() {
        ...
        assertFalse(jwtProvider.isRefreshTokenExpired(
                jwtProvider.generateSignInToken(TestUtils.getTokenDetails(1L)).getRefreshToken()
        ));
    ...
    void testSubjectExtraction() {
        ...
        TokenDetails tokenDetails = jwtProvider.extractAccessTokenDetails(
                jwtProvider.generateSignInToken(TestUtils.getTokenDetails(1L)).getAccessToken()
        );
